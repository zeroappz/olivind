            ...
            <div class="themesflat-row gutter-30">
                ...
                <div class="col span_1_of_4">
                    ...
                    <div class="widget widget_tags">
                        ...
                        <div class="tags-list">
                            <a href="prod-olivine.php">Olivine Sand</a>
                            <a href="prod-refractory.php">Refractory Mixes</a>
                            <a href="prod-ebt.php">EBT filter Sand</a>
                            <a href="prod-slag.php">Slag Conditioner</a>
                            <a href="prod-blast.php">Sand Blasting</a>
                        ...
                        <div class="instagram-wrap data-effect clearfix col3 g10">
                            <ul>
                                <li style="padding: 7px 0px;">
                                    <span><i class="fa fa-location-arrow" style="color: #9ab973;"></i></span> &nbsp; # 154/C-2, Barathiyar Street, Kalarampatti Main Road, Salem - 636015. Tamil Nadu.
                                </li>
                                <li style="padding: 7px 0px;">
                                    <span><i class="fa fa-phone-square" style="color: #9ab973;"></i></span> &nbsp; +91 94452 03057 | 96003 49333
                                </li>
                                <li style="padding: 7px 0px;">
                                    <span><i class="fa fa-envelope" style="color: #9ab973;"></i></span> &nbsp; south.asian.minerals@hotmail.com
                                </li>
                            </ul>
        ...
        <div id="bottom-bar-inner" class="container">
            <div class="bottom-bar-inner-wrap">
                <div class="bottom-bar-content">
                    <div id="copyright">© <span class="text">Copyright © 2020 South Asian Minerals | Powered By <a style="color: #9ab973;" href="https://zeroappz.com">ZeroAppz</a></span>
                    </div>
                </div>
                <!-- /.bottom-bar-content -->
